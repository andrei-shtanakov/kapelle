...
- Ревью PR: **Copilot по умолчанию НЕ запрашивается** (решение владельца 2026-08-25,
  ...
  троттлинг у кромки бюджета, перезапрос платный). Умолчание итераций с гейтом
  codex-review — экономный цикл: итерировать локально `sh scripts/review/local.sh`
  до чистого вердикта (подписочный codex, $0 API) → пушить **драфтом** (CI-итерации
  бесплатны, deferred) → снятие драфта = один платный прогон на приёмку.
