...
own durability doing so (guide §9, exit criteria §9.3). S1 implementation: docs/superpowers/plans/2026-08-14-product-s1-vendoring-skeleton.md. S2 implementation: docs/superpowers/plans/2026-08-14-product-s2-state-and-oracle.md. S3 implementation: docs/superpowers/plans/2026-08-14-product-s3-workers-e2e.md.
